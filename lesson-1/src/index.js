                ...
                <MDBContainer>
                    <MDBRow>
                        ...
                        <MDBCol md="3">
                            ...
                            <h6 className="my-3">
                                It is going to be busy that today. You have {" "}<b>{this.state.events.length} events</b> today.
                            </h6>
                            <h1 className="my-3">
                                <MDBRow>
                            ...
                            <p>
                                Don't forget your sunglasses. Today will dry and sunny, becoming warm in the afternoon with temeratures of between 20 and 25 degrees.
                            </p>
                        </MDBCol>
                    </MDBRow>
                </MDBContainer>
                <MDBModal isOpen={this.state.modal} toggle={this.toogleModal}>
                    <MDBModalHeader
                    className="text-center"
                    titleClass="1-100 font-weight-bold"
